...
function InfoPage({ type }) {
    ...
    return (
        <>
            <div
                className="fixed flex flex-col w-screen top-20 overflow-hidden scroll-hide overflow-y-auto bg-indigo-900"
            >
                <div
                    className="flex flex-col flex-1 h-auto w-auto m-5 sm:m-10 p-7 rounded-3xl shadow-lg shadow-black" style={{ "backgroundColor": `rgba(255,255,255,0.2)` }}
                >
                    <h1
                    ...
                    />
                    <div
                        className="w-auto h-[50vh] flex justify-center flex-grow flex-wrap rounded-3xl p-10 overflow-clip overflow-y-auto scroll-hide gap-10 shadow-md shadow-black"
